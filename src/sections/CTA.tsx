  ...
  return (
    <section id="cta" className="relative scroll-mt-24 overflow-hidden border-t border-white/[0.05]">
      ...
      <div className="relative mx-auto max-w-4xl px-5 py-28 text-center sm:px-8 lg:py-36">
        ...
        <Reveal delay={0.08}>
          <h2 className="mt-8 font-display text-5xl font-semibold leading-[1.05] tracking-tight text-white sm:text-6xl">
        ...
        <Reveal delay={0.24}>
          <div className="mt-10 flex flex-col items-center gap-4">
            <a
              href="mailto:hello@callaudit.co?subject=Free%20Call%20Audit%20Request"
